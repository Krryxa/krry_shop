	...
	<div>
		...
		<div class="content">
			...
			<div class="con_boxs">
				...
				<input type="number" @blur="changeToFixed" v-model.number="shop.price">
				...
				<button class="sumbie btn btn-danger right" @click="beforeAdd">保存</button>
...
<script type="text/javascript">
	...
	export default{
      ...
      changeToFixed () {
        this.shop['price'] = parseFloat(this.shop['price']).toFixed(2);
      },
			back () {
				//返回一级
				this.$router.go(-1);
